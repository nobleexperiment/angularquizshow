(function () {
    ...
    var url = '/api/quiz';
    QuizService.$inject = ['$http', '$q', '$timeout'];

    function QuizService($http, $q, $timeout) {
        return {
    ...
    var quiz_citizenship = {
        "title": "U.S. Citizenship",
        "_id": "edd49b0befb44380b94cad6c070f1668",
    ...
    var quiz_cat_lady = {
        "title": "Cat Lady",
        "_id": "693317e33adb4e35bbe9880583c4f1dc",
        ...
        questions: [
            ...
            },
            {
                ...
                "choices": [
                    ...
                    {"choice": "Answer three, but I would adopt it if the owner could not be found.", "isAnswer": "true"}
                ]
            },
            {
            ...
            },
            {
                ...
                "choices": [
                    {"choice": "Give up beer and movies this week and buy my cats their regular food.", "isAnswer": "true"},
            ...
            },
            {
                ...
                "choices": [
                    ...
                    {"choice": "Hire a bonded, professional sitter or a trusted neighbor.", "isAnswer": "true"},
